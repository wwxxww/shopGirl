    ...
    <div class="search-modal"  v-show="modalShow">
      <div class="search-box">
        ...
        <div class="search-category">
          <dl class="subcate">
            <dt>手机 <i class="fa fa-arrow-right fastyle" ></i> </dt>
            <dt>美图M8<i class="fa fa-arrow-right fastyle" ></i></dt>
            <dt>常规配件<i class="fa fa-arrow-right fastyle" ></i></dt>
            <dt>拍摄配件<i class="fa fa-arrow-right fastyle" ></i></dt>
            <dt>MeituFamily专区<i class="fa fa-arrow-right fastyle" ></i></dt>
            <dt>线下体验点<i class="fa fa-arrow-right fastyle" ></i></dt>
          </dl>
        </div>
      </div>
    </div>
